...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._btnCreaCammino = ft.ElevatedButton(text="Trova Cammino", on_click=self._controller.handleCammino, width=250, disabled=True)

        row2 = ft.Row([self._ddArtist, self._btnCreaCammino],
                      alignment=ft.MainAxisAlignment.CENTER)
